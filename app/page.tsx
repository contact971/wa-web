    ...
    <div className="grid items-center gap-10 p-10 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-5 text-lg text-gray-700">
          Audit ciblé, correctifs prioritaires et validation avant mise en ligne.
          L’objectif : réduire les irritants, améliorer l’accessibilité de base et
          stabiliser l’existant avec une démarche défendable.
        </p>

        {/* 🔒 Verrou institutionnel */}
        <p className="mt-4 text-sm text-gray-600">
          Approche conçue pour des environnements municipaux : interventions traçables,
          documentation claire et validation avant toute mise en ligne.
        </p>
        ...
        <div className="mt-6 space-y-2 text-sm text-gray-700">
          <p>• Documentation claire (rapport + priorités + estimation).</p>
          <p>• Changements appliqués par étapes, avec validation avant mise en ligne.</p>
          <p>• Approche compatible avec les réalités des petites municipalités.</p>
        </div>
...
>
  ...
  <p className="mx-auto mt-4 max-w-3xl text-center text-sm text-gray-700">
    Les interventions sont volontairement ciblées afin de limiter les impacts,
    faciliter l’approbation interne et éviter les projets lourds.
  </p>
...
>
  <div className="mt-10 grid gap-6 lg:grid-cols-3">
    ...
    <div className="rounded-2xl border border-black/10 bg-white/70 p-7 shadow-sm backdrop-blur">
      ...
      <p className="mt-4 text-sm text-gray-700">
        <span className="font-semibold">Livrable :</span> rapport clair, priorités identifiées et estimation
        de charge.
      </p>
    ...
    <div className="rounded-2xl border border-black/15 bg-white/80 p-7 shadow-sm backdrop-blur">
      ...
      <p className="mt-4 text-sm text-gray-700">
        <span className="font-semibold">Livrable :</span> rapport, correctifs convenus et validation finale
        avant mise en ligne.
      </p>
    ...
    <div className="rounded-2xl border border-black/10 bg-white/70 p-7 shadow-sm backdrop-blur">
      ...
      <p className="mt-4 text-sm text-gray-700">
        <span className="font-semibold">Livrable :</span> vérifications périodiques, petites corrections et
        compte rendu.
      </p>
  ...
  <div className="mt-10 text-center">
    <p className="text-sm text-gray-600">
      Aucun engagement. Une proposition est préparée uniquement après compréhension du contexte,
      des priorités et des contraintes municipales.
    </p>
...
>
  ...
  <p className="mx-auto mt-2 max-w-3xl text-center text-sm text-gray-700">
    L’exemple présenté met l’accent sur la méthodologie, la structure et la documentation —
    et non sur l’organisation ou les données.
  </p>
  ...
  <div className="mt-8 grid gap-8 md:grid-cols-2">
    ...
    <div className="rounded-2xl border border-black/10 bg-white/70 p-6 shadow-sm backdrop-blur">
      ...
      <p className="mt-3 text-sm text-gray-700">
        Exemple de réalisation démontrant une structure claire, maintenable et documentée :
        priorisation, plan d’intervention et validation avant mise en ligne.
      </p>
      ...
      <p className="mt-4 text-xs text-gray-600">
        Aperçu présenté à titre illustratif — aucune donnée réelle ou municipale.
      </p>
    </div>
          ...
          {[
            {
              ...
              a: "Pas nécessairement. L’approche vise d’abord à fiabiliser l’existant avec des correctifs ciblés. Une refonte n’est envisagée que si elle devient justifiée.",
            },
            {
  q: "Est-ce que l’objectif est de forcer une refonte du site ?",
  a: "Non. L’objectif est de permettre à la municipalité de décider avec une information claire et structurée. Une refonte n’est envisagée que si elle devient justifiée et souhaitée.",
},
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-start">
          <div>
            ...
            <p className="mt-3 text-gray-700">
              ...
              <span className="block mt-2 text-sm text-gray-600">Réponse habituelle : 1 à 2 jours ouvrables.</span>
            </p>

            <div className="mt-6 space-y-2 text-sm text-gray-700">
              <p className="font-semibold">William Arseneault — Consultant – Solutions web</p>
              <p>📧 william.arsenault@hotmail.ca</p>
              <p>📞 450-513-4490</p>
            </div>
          </div>

          <form className="rounded-2xl border border-black/10 bg-white/70 p-8 backdrop-blur">
            <div className="grid gap-4">
              ...
              <div>
                <label className="text-sm font-medium" htmlFor="courriel">Courriel</label>
                <input
                  id="courriel"
                  name="courriel"
                  type="email"
              ...
              <button
                type="button"
                className="mt-2 rounded-md bg-black px-5 py-3 font-medium text-white hover:bg-gray-800"
              >
                Soumettre la demande
              </button>

              <p className="text-xs text-gray-600">
                (Formulaire visuel pour l’instant — connexion plus tard.)
              </p>
            </div>
          </form>
        </div>
      ...
      <footer className="border-t border-black/10 bg-white/40 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 py-8 text-sm text-gray-600">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <p>© {new Date().getFullYear()} William Arseneault — Consultant – Solutions web</p>
